# NetBIOS Hacking
	...
	ping demo1.ine.local
		PING demo1.ine.local (10.0.29.163) 56(84) bytes of data.
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
# DNS & SMB Relay Attack
	...
	與 meterpreter 會話互動
	sessions
	  1         meterpreter x86/windows  NT AUTHORITY\SYSTEM @ FILE  172.16.5.101:4444 -> 172.1
